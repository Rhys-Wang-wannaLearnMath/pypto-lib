...
|------|------|
| **优化编号** | S3-1 |
| **目标文件** | `examples/models/qwen-opt/qwen3_32b_decode_scope3.py` |
...
```bash
python examples/models/qwen-opt/qwen3_32b_decode_scope3.py -p a2a3sim
```
...
```bash
# 带 profiling 运行
python examples/models/qwen-opt/qwen3_32b_decode_scope3.py -p a2a3sim --runtime-profiling
